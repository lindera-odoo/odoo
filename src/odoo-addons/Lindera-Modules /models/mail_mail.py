            ...
            if token_backend.check_token() and allowtosend:
                try:
                    ...
                    if account.is_authenticated:
                        ...
                        attachments = [(BytesIO(base64.b64decode(a['datas'])), a['datas_fname']) for a in
                                       attachments.sudo().read(['datas_fname', 'datas']) if a['datas'] is not False]
                        ...
                        for email in email_list:
                            ...
                            try:
                                ...
                                for message in sent:
                                    if mail.subject == message.subject and abs(
                                            now - message.sent.utcnow()) < datetime.timedelta(seconds=2):
